	...
	>
		...
		<div class="flex flex-col gap-5 mt-2">
			...
			{#if !isEditing}
				...
				<!-- Status -->
				<div class="flex flex-col gap-1.5 mt-1">
					<span class="text-xs text-gray-500 uppercase tracking-wider font-semibold">Current Status</span>
					<span class="text-lg tracking-wide {isPaid ? 'text-[#69db7c]' : 'text-gray-400'} border-b border-transparent w-full inline-block pb-0.5">
